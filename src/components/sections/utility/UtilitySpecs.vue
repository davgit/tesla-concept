<template>
    <div class="utility-callout-wrapper w-largeDesktop ml-auto mr-auto flex items-center px-spc15 mb-spc16">
        <div class="callout-item pr-5 lg:text-left sm:text-center sm:flex-1">
            <h1 class="callout-title flex items-end text-size28 font-semibold text-primary h-12 lg:justify-start sm:justify-center">
                88 <span>cu ft</span>
            </h1>
            <p class="callout-desc text-xs font-medium leading-spc3 lg:block sm:hidden">
                Best in class storage, with more cargo room than most sport utility vehicles
            </p>
            <p class="rp callout-desc text-xs font-medium leading-spc3 lg:hidden sm:block">
                Best in class <br>storage
            </p>
        </div>
        <div class="callout-item px-5 lg:text-left sm:text-center sm:flex-1">
            <h1 class="callout-title flex items-center text-size28 font-semibold text-primary h-12 lg:justify-start sm:justify-center">
                <svg width="40px" height="41px" viewBox="0 0 40 41" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>MX_room-for-7</title>
                    <desc>Created with Sketch.</desc>
                    <g id="MX_room-for-7" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(0.000000, 1.000000)">
                        <g id="seat" transform="translate(7.000000, 7.000000)" fill="#171a20" fill-rule="nonzero">
            ...
            <p class="callout-desc text-xs font-medium leading-spc3 lg:block sm:hidden">
                Maximum passenger and cargo capacity, with seating for up to seven adults
            </p>
            <p class="rp callout-desc text-xs font-medium leading-spc3 lg:hidden sm:block">
                Seating <br>for seven
            </p>
        </div>
        <div class="callout-item pl-5 lg:text-left sm:text-center sm:flex-1">
            <h1 class="callout-title flex items-center text-14 h-12 lg:justify-start sm:justify-center">
                <img src="../../../assets/images/MX_falcon-wings.svg" alt="man sit">
                <span class="lg:block sm:hidden text-14 font-medium pl-1">Falcon Wing <br>Doors</span>
            </h1>
            <p class="callout-desc text-xs font-medium leading-spc3 lg:block sm:hidden">
                Enhances accessibility to back rows and opens in the tightest parking spaces
            </p>
            <p class="rp callout-desc text-xs font-medium leading-spc3 lg:hidden sm:block">
                Falcon Wing <br>Doors
            </p>
        </div>
    </div>
</template>
